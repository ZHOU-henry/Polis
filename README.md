...
Open umbrella program for the market, observability, and judgment layers of the
AI economy.

Chinese shorthand: `智能经济协同`
...
contents have been copied into `subprojects/noesis/` and `subprojects/peras/`.

## Subprojects

- `Agora`
  - market and delivery infrastructure for AI agents
- `Noesis`
  - observatory for human-machine symbiosis, institutions, and AGI-era social
    evolution
- `Peras`
...
- a market layer without strategic intelligence becomes shallow
